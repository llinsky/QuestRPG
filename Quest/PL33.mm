...
-(id)init
{
    if (self = [super init])
    {
        ...
        self.theHKMap = [HKTMXTiledMap tiledMapWithTMXFile:@"playlayer33_FINAL1.tmx"];
        ...
        if (!self.hero.gotItem55)
        {
            self.item55 = [CCSprite spriteWithFile:@"treasurechestSprite01.png"];
            NSMutableDictionary *item = [objects objectNamed:@"item55"];
            double x1 = [[item valueForKey:@"x"]floatValue];
            double y1 = [[item valueForKey:@"y"]floatValue];
            self.item55.position = ccp(x1,y1);
            [self.theHKMap addChild:self.item55 z:self.bgLayer.zOrder];
        }
        else
        {
            self.item55 = [CCSprite spriteWithFile:@"treasurechestSprite02.png"];
            NSMutableDictionary *item = [objects objectNamed:@"item55"];
            double x1 = [[item valueForKey:@"x"]floatValue];
            double y1 = [[item valueForKey:@"y"]floatValue];
            self.item55.position = ccp(x1,y1);
        ...
        else if (self.hero.mapInitMode == 2)
        {
            ...
            else if (self.hero.currentMap == 34)
            {
...
-(void)pickedUpItem:(int)itemCode
{
    ...
    if (itemCode == 55)
    {
        CGPoint pos = self.item55.position;
        self.hero.gotItem55 = YES;
        [self.theHKMap removeChild:self.item55 cleanup:YES];
        self.item55 = [CCSprite spriteWithFile:@"treasurechestSprite02.png"];
        self.item55.position = pos;
        [self.theHKMap addChild:self.item55 z:self.bgLayer.zOrder];
...
- (void) setPlayerPosition: (CGPoint) position
{
    ...
    if (tileGID)
    {
        ...
        if (properties)
        {
            ...
            NSString *gate7 = [properties valueForKey:@"stairs34"];
...
- (void) dsetPlayerPosition: (CGPoint) position
{
    ...
    if (tileGID)
    {
        ...
        if (properties)
        {
            ...
            NSString *gate4 = [properties valueForKey:@"stairs34"];
...
- (void) pressedA
{
    ...
    if (tileGID)
    {
        ...
        if (properties)
        {
            ...
            NSString *mapItem55 = [properties valueForKey:@"item55"];
            if (mapItem55 && [mapItem55 compare:@"true"] == NSOrderedSame)
            {
