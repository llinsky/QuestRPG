...
-(id)init
{
    if (self = [super init])
    {
        ...
        self.theHKMap = [HKTMXTiledMap tiledMapWithTMXFile:@"playlayer32_FINAL1.tmx"];
        ...
        if (!self.hero.gotItem53)
        {
            self.item53 = [CCSprite spriteWithFile:@"treasurechestSprite01.png"];
            NSMutableDictionary *item = [objects objectNamed:@"item53"];
            double x1 = [[item valueForKey:@"x"]floatValue];
            double y1 = [[item valueForKey:@"y"]floatValue];
            self.item53.position = ccp(x1,y1);
            [self.theHKMap addChild:self.item53 z:self.bgLayer.zOrder];
        }
        else
        {
            self.item53 = [CCSprite spriteWithFile:@"treasurechestSprite02.png"];
            NSMutableDictionary *item = [objects objectNamed:@"item53"];
            double x1 = [[item valueForKey:@"x"]floatValue];
            double y1 = [[item valueForKey:@"y"]floatValue];
            self.item53.position = ccp(x1,y1);
        ...
        if (!self.hero.gotItem54)
        {
            self.item54 = [CCSprite spriteWithFile:@"treasurechestSprite01.png"];
            NSMutableDictionary *item = [objects objectNamed:@"item54"];
            double x1 = [[item valueForKey:@"x"]floatValue];
            double y1 = [[item valueForKey:@"y"]floatValue];
            self.item54.position = ccp(x1,y1);
            [self.theHKMap addChild:self.item54 z:self.bgLayer.zOrder];
        }
        else
        {
            self.item54 = [CCSprite spriteWithFile:@"treasurechestSprite02.png"];
            NSMutableDictionary *item = [objects objectNamed:@"item54"];
            double x1 = [[item valueForKey:@"x"]floatValue];
            double y1 = [[item valueForKey:@"y"]floatValue];
            self.item54.position = ccp(x1,y1);
        ...
        else if (self.hero.mapInitMode == 2)
        {
            ...
            else if (self.hero.currentMap == 33)
            {
...
-(void)pickedUpItem:(int)itemCode
{
    ...
    if (itemCode == 53)
    {
        CGPoint pos = self.item53.position;
        self.hero.gotItem53 = YES;
        [self.theHKMap removeChild:self.item53 cleanup:YES];
        self.item53 = [CCSprite spriteWithFile:@"treasurechestSprite02.png"];
        self.item53.position = pos;
        [self.theHKMap addChild:self.item53 z:self.bgLayer.zOrder];
    ...
    {
        CGPoint pos = self.item54.position;
        self.hero.gotItem54 = YES;
        [self.theHKMap removeChild:self.item54 cleanup:YES];
        self.item54 = [CCSprite spriteWithFile:@"treasurechestSprite02.png"];
        self.item54.position = pos;
        [self.theHKMap addChild:self.item54 z:self.bgLayer.zOrder];
...
- (void) setPlayerPosition: (CGPoint) position
{
    ...
    if (tileGID)
    {
        ...
        if (properties)
        {
            ...
            NSString *gate = [properties valueForKey:@"stairs31"];
...
- (void) pressedA
{
    ...
    if (tileGID)
    {
        ...
        if (properties)
        {
            ...
            NSString *mapItem53 = [properties valueForKey:@"item53"];
            if (mapItem53 && [mapItem53 compare:@"true"] == NSOrderedSame)
            {
            ...
            NSString *mapItem54 = [properties valueForKey:@"item54"];
            if (mapItem54 && [mapItem54 compare:@"true"] == NSOrderedSame)
            {
