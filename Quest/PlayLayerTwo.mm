...
-(void) moveleftSprite30
{
    ...
    sprite30Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite30
{
    ...
    sprite30Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite30
{
    CGPoint sprite30Pos = self.sprite30.position;
    self.sprite30.orientation = 1;
    sprite30Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite32
{
    ...
    sprite32Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite32
{
    ...
    sprite32Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite32
{
    ...
    sprite32Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite33
{
    ...
    sprite33Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite33
{
    ...
    sprite33Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite33
{
    CGPoint sprite33Pos = self.sprite33.position;
    self.sprite33.orientation = 1;
    sprite33Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite34
{
    ...
    sprite34Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite34
{
    ...
    sprite34Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite34
{
    CGPoint sprite34Pos = self.sprite34.position;
    self.sprite34.orientation = 1;
    sprite34Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite35
{
    ...
    sprite35Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite35
{
    ...
    sprite35Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite35
{
    ...
    sprite35Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite36
{
    ...
    sprite36Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite36
{
    ...
    sprite36Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite36
{
    CGPoint sprite36Pos = self.sprite36.position;
    self.sprite36.orientation = 1;
    sprite36Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite37
{
    ...
    sprite37Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite37
{
    ...
    sprite37Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite37
{
    CGPoint sprite37Pos = self.sprite37.position;
    self.sprite37.orientation = 1;
    sprite37Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite38
{
    ...
    sprite38Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite38
{
    ...
    sprite38Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite38
{
    CGPoint sprite38Pos = self.sprite38.position;
    self.sprite38.orientation = 1;
    sprite38Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite39
{
    ...
    sprite39Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite39
{
    ...
    sprite39Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite39
{
    CGPoint sprite39Pos = self.sprite39.position;
    self.sprite39.orientation = 1;
    sprite39Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite40
{
    ...
    sprite40Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite40
{
    ...
    sprite40Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite40
{
    CGPoint sprite40Pos = self.sprite40.position;
    self.sprite40.orientation = 1;
    sprite40Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite41
{
    ...
    sprite41Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite41
{
    CGPoint sprite41Pos = self.sprite41.position;
    self.sprite41.orientation = 2;
    sprite41Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite41
{
    ...
    sprite41Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite42
{
    ...
    sprite42Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite42
{
    ...
    sprite42Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite42
{
    CGPoint sprite42Pos = self.sprite42.position;
    self.sprite42.orientation = 1;
    sprite42Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite43
{
    ...
    sprite43Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite43
{
    ...
    sprite43Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite43
{
    CGPoint sprite43Pos = self.sprite43.position;
    self.sprite43.orientation = 1;
    sprite43Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite44
{
    ...
    sprite44Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite44
{
    ...
    sprite44Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite44
{
    CGPoint sprite44Pos = self.sprite44.position;
    self.sprite44.orientation = 1;
    sprite44Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite45
{
    ...
    sprite45Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite45
{
    ...
    sprite45Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite45
{
    CGPoint sprite45Pos = self.sprite45.position;
    self.sprite45.orientation = 1;
    sprite45Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite46
{
    ...
    sprite46Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite46
{
    ...
    sprite46Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite46
{
    CGPoint sprite46Pos = self.sprite46.position;
    self.sprite46.orientation = 1;
    sprite46Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite47
{
    ...
    sprite47Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite47
{
    ...
    sprite47Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite47
{
    CGPoint sprite47Pos = self.sprite47.position;
    self.sprite47.orientation = 1;
    sprite47Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite48
{
    ...
    sprite48Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite48
{
    ...
    sprite48Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite48
{
    CGPoint sprite48Pos = self.sprite48.position;
    self.sprite48.orientation = 1;
    sprite48Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite49
{
    ...
    sprite49Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite49
{
    ...
    sprite49Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite49
{
    CGPoint sprite49Pos = self.sprite49.position;
    self.sprite49.orientation = 1;
    sprite49Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite50
{
    ...
    sprite50Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite50
{
    ...
    sprite50Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite50
{
    CGPoint sprite50Pos = self.sprite50.position;
    self.sprite50.orientation = 1;
    sprite50Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite51
{
    ...
    self.sprite51.orientation = 4;
    sprite51Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite51
{
    ...
    sprite51Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite51
{
    ...
    sprite51Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite52
{
    ...
    sprite52Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite52
{
    CGPoint sprite52Pos = self.sprite52.position;
    self.sprite52.orientation = 2;
    sprite52Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite52
{
    ...
    sprite52Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite53
{
    ...
    sprite53Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite53
{
    CGPoint sprite53Pos = self.sprite53.position;
    self.sprite53.orientation = 2;
    sprite53Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite53
{
    ...
    sprite53Pos.y -= theHKMap.tileSize.width;
