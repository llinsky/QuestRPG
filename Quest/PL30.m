...
-(id)init
{
    if (self = [super init])
    {
        ...
        self.theHKMap = [HKTMXTiledMap tiledMapWithTMXFile:@"playlayer30_FINAL1.tmx"];
        ...
        if (!self.hero.gotItem50)
        {
            self.item50 = [CCSprite spriteWithFile:@"treasurechestSprite01.png"];
            NSMutableDictionary *item = [objects objectNamed:@"item50"];
            double x1 = [[item valueForKey:@"x"]floatValue];
            double y1 = [[item valueForKey:@"y"]floatValue];
            self.item50.position = ccp(x1,y1);
            [self.theHKMap addChild:self.item50 z:self.bgLayer.zOrder];
        }
        else
        {
            self.item50 = [CCSprite spriteWithFile:@"treasurechestSprite02.png"];
            NSMutableDictionary *item = [objects objectNamed:@"item50"];
            double x1 = [[item valueForKey:@"x"]floatValue];
            double y1 = [[item valueForKey:@"y"]floatValue];
            self.item50.position = ccp(x1,y1);
        ...
        if (!self.hero.gotItem51)
        {
            self.item51 = [CCSprite spriteWithFile:@"treasurechestSprite01.png"];
            NSMutableDictionary *item = [objects objectNamed:@"item51"];
            double x1 = [[item valueForKey:@"x"]floatValue];
            double y1 = [[item valueForKey:@"y"]floatValue];
            self.item51.position = ccp(x1,y1);
            [self.theHKMap addChild:self.item51 z:self.bgLayer.zOrder];
        }
        else
        {
            self.item51 = [CCSprite spriteWithFile:@"treasurechestSprite02.png"];
            NSMutableDictionary *item = [objects objectNamed:@"item51"];
            double x1 = [[item valueForKey:@"x"]floatValue];
            double y1 = [[item valueForKey:@"y"]floatValue];
            self.item51.position = ccp(x1,y1);
        ...
        else if (self.hero.mapInitMode == 2)
        {
            ...
            else if (self.hero.currentMap == 31)
            {
...
-(void)pickedUpItem:(int)itemCode
{
    ...
    if (itemCode == 50)
    {
        CGPoint pos = self.item50.position;
        self.hero.gotItem50 = YES;
        [self.theHKMap removeChild:self.item50 cleanup:YES];
        self.item50 = [CCSprite spriteWithFile:@"treasurechestSprite02.png"];
        self.item50.position = pos;
        [self.theHKMap addChild:self.item50 z:self.bgLayer.zOrder];
    ...
    {
        CGPoint pos = self.item51.position;
        self.hero.gotItem51 = YES;
        [self.theHKMap removeChild:self.item51 cleanup:YES];
        self.item51 = [CCSprite spriteWithFile:@"treasurechestSprite02.png"];
        self.item51.position = pos;
        [self.theHKMap addChild:self.item51 z:self.bgLayer.zOrder];
...
- (void) pressedA
{
    ...
    if (tileGID)
    {
        ...
        if (properties)
        {
            ...
            NSString *mapItem50 = [properties valueForKey:@"item50"];
            if (mapItem50 && [mapItem50 compare:@"true"] == NSOrderedSame)
            {
            ...
            NSString *mapItem51 = [properties valueForKey:@"item51"];
            if (mapItem51 && [mapItem51 compare:@"true"] == NSOrderedSame)
            {
