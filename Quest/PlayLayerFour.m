...
-(void) moveleftSprite81
{
    ...
    sprite81Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite81
{
    ...
    sprite81Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite81
{
    CGPoint sprite81Pos = self.sprite81.position;
    self.sprite81.orientation = 1;
    sprite81Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite82
{
    ...
    sprite82Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite82
{
    ...
    sprite82Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite82
{
    CGPoint sprite82Pos = self.sprite82.position;
    self.sprite82.orientation = 1;
    sprite82Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite83
{
    ...
    sprite83Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite83
{
    ...
    sprite83Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite83
{
    ...
    sprite83Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite84
{
    ...
    sprite84Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite84
{
    ...
    sprite84Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite84
{
    CGPoint sprite84Pos = self.sprite84.position;
    self.sprite84.orientation = 1;
    sprite84Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite85
{
    ...
    sprite85Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite85
{
    ...
    sprite85Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite85
{
    CGPoint sprite85Pos = self.sprite85.position;
    self.sprite85.orientation = 1;
    sprite85Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite86
{
    ...
    sprite86Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite86
{
    ...
    sprite86Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite86
{
    CGPoint sprite86Pos = self.sprite86.position;
    self.sprite86.orientation = 1;
    sprite86Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite87
{
    ...
    sprite87Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite87
{
    ...
    sprite87Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite87
{
    CGPoint sprite87Pos = self.sprite87.position;
    self.sprite87.orientation = 1;
    sprite87Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite88
{
    ...
    sprite88Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite88
{
    ...
    sprite88Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite88
{
    CGPoint sprite88Pos = self.sprite88.position;
    self.sprite88.orientation = 1;
    sprite88Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite89
{
    ...
    sprite89Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite89
{
    ...
    sprite89Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite89
{
    CGPoint sprite89Pos = self.sprite89.position;
    self.sprite89.orientation = 1;
    sprite89Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite90
{
    ...
    sprite90Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite90
{
    ...
    sprite90Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite90
{
    CGPoint sprite90Pos = self.sprite90.position;
    self.sprite90.orientation = 1;
    sprite90Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite91
{
    ...
    sprite91Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite91
{
    ...
    sprite91Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite91
{
    CGPoint sprite91Pos = self.sprite91.position;
    self.sprite91.orientation = 1;
    sprite91Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite92
{
    ...
    sprite92Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite92
{
    ...
    sprite92Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite92
{
    CGPoint sprite92Pos = self.sprite92.position;
    self.sprite92.orientation = 1;
    sprite92Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite93
{
    ...
    sprite93Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite93
{
    ...
    sprite93Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite93
{
    CGPoint sprite93Pos = self.sprite93.position;
    self.sprite93.orientation = 1;
    sprite93Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite94
{
    ...
    sprite94Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite94
{
    ...
    sprite94Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite94
{
    CGPoint sprite94Pos = self.sprite94.position;
    self.sprite94.orientation = 1;
    sprite94Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite95
{
    ...
    sprite95Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite95
{
    ...
    sprite95Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite95
{
    CGPoint sprite95Pos = self.sprite95.position;
    self.sprite95.orientation = 1;
    sprite95Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite96
{
    ...
    sprite96Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite96
{
    ...
    sprite96Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite96
{
    CGPoint sprite96Pos = self.sprite96.position;
    self.sprite96.orientation = 1;
    sprite96Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite97
{
    ...
    sprite97Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite97
{
    ...
    sprite97Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite97
{
    CGPoint sprite97Pos = self.sprite97.position;
    self.sprite97.orientation = 1;
    sprite97Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite98
{
    ...
    sprite98Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite98
{
    ...
    sprite98Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite98
{
    CGPoint sprite98Pos = self.sprite98.position;
    self.sprite98.orientation = 1;
    sprite98Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite99
{
    ...
    sprite99Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite99
{
    ...
    sprite99Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite99
{
    CGPoint sprite99Pos = self.sprite99.position;
    self.sprite99.orientation = 1;
    sprite99Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite100
{
    ...
    sprite100Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite100
{
    ...
    sprite100Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite100
{
    CGPoint sprite100Pos = self.sprite100.position;
    self.sprite100.orientation = 1;
    sprite100Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite101
{
    ...
    sprite101Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite101
{
    ...
    sprite101Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite101
{
    CGPoint sprite101Pos = self.sprite101.position;
    self.sprite101.orientation = 1;
    sprite101Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite102
{
    ...
    sprite102Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite102
{
    ...
    sprite102Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite102
{
    CGPoint sprite102Pos = self.sprite102.position;
    self.sprite102.orientation = 1;
    sprite102Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite103
{
    ...
    sprite103Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite103
{
    ...
    sprite103Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite103
{
    CGPoint sprite103Pos = self.sprite103.position;
    self.sprite103.orientation = 1;
    sprite103Pos.y -= _theHKMap.tileSize.width;
...
-(void) moveleftSprite104
{
    ...
    sprite104Pos.x -= _theHKMap.tileSize.width;
...
-(void) moveupSprite104
{
    ...
    sprite104Pos.y += _theHKMap.tileSize.height;
...
-(void) movedownSprite104
{
    CGPoint sprite104Pos = self.sprite104.position;
    self.sprite104.orientation = 1;
    sprite104Pos.y -= _theHKMap.tileSize.width;
