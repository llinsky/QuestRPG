...
-(void) moveleftSprite61
{
    ...
    sprite61Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite61
{
    ...
    sprite61Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite61
{
    CGPoint sprite61Pos = self.sprite61.position;
    self.sprite61.orientation = 1;
    sprite61Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite62
{
    ...
    sprite62Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite62
{
    ...
    sprite62Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite62
{
    CGPoint sprite62Pos = self.sprite62.position;
    self.sprite62.orientation = 1;
    sprite62Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite63
{
    ...
    sprite63Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite63
{
    ...
    sprite63Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite63
{
    CGPoint sprite63Pos = self.sprite63.position;
    self.sprite63.orientation = 1;
    sprite63Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite64
{
    ...
    sprite64Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite64
{
    ...
    sprite64Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite64
{
    CGPoint sprite64Pos = self.sprite64.position;
    self.sprite64.orientation = 1;
    sprite64Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite65
{
    ...
    sprite65Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite65
{
    ...
    sprite65Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite65
{
    CGPoint sprite65Pos = self.sprite65.position;
    self.sprite65.orientation = 1;
    sprite65Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite66
{
    ...
    sprite66Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite66
{
    ...
    sprite66Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite66
{
    CGPoint sprite66Pos = self.sprite66.position;
    self.sprite66.orientation = 1;
    sprite66Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite67
{
    ...
    sprite67Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite67
{
    ...
    sprite67Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite67
{
    CGPoint sprite67Pos = self.sprite67.position;
    self.sprite67.orientation = 1;
    sprite67Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite68
{
    ...
    sprite68Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite68
{
    ...
    sprite68Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite68
{
    CGPoint sprite68Pos = self.sprite68.position;
    self.sprite68.orientation = 1;
    sprite68Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite69
{
    ...
    sprite69Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite69
{
    ...
    sprite69Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite69
{
    CGPoint sprite69Pos = self.sprite69.position;
    self.sprite69.orientation = 1;
    sprite69Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite70
{
    ...
    sprite70Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite70
{
    ...
    sprite70Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite70
{
    CGPoint sprite70Pos = self.sprite70.position;
    self.sprite70.orientation = 1;
    sprite70Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite71
{
    ...
    sprite71Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite71
{
    ...
    sprite71Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite71
{
    CGPoint sprite71Pos = self.sprite71.position;
    self.sprite71.orientation = 1;
    sprite71Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite72
{
    ...
    sprite72Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite72
{
    ...
    sprite72Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite72
{
    CGPoint sprite72Pos = self.sprite72.position;
    self.sprite72.orientation = 1;
    sprite72Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite73
{
    ...
    sprite73Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite73
{
    ...
    sprite73Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite73
{
    CGPoint sprite73Pos = self.sprite73.position;
    self.sprite73.orientation = 1;
    sprite73Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite74
{
    ...
    sprite74Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite74
{
    ...
    sprite74Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite74
{
    CGPoint sprite74Pos = self.sprite74.position;
    self.sprite74.orientation = 1;
    sprite74Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite75
{
    ...
    sprite75Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite75
{
    ...
    sprite75Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite75
{
    CGPoint sprite75Pos = self.sprite75.position;
    self.sprite75.orientation = 1;
    sprite75Pos.y -= theHKMap.tileSize.width;
...
-(void) moveleftSprite76
{
    ...
    sprite76Pos.x -= theHKMap.tileSize.width;
...
-(void) moveupSprite76
{
    ...
    sprite76Pos.y += theHKMap.tileSize.height;
...
-(void) movedownSprite76
{
    CGPoint sprite76Pos = self.sprite76.position;
    self.sprite76.orientation = 1;
    sprite76Pos.y -= theHKMap.tileSize.width;
